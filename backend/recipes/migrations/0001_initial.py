# Generated by Django 3.2.19 on 2023-06-07 14:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное количество ингредиента: 1 ед.'), django.core.validators.MaxValueValidator(3000, message='Максимальное количество ингредиента: 3000 ед.')], verbose_name='Количество ингредиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.IntegerField(validators=[django.core.validators.MinValueValidator(1, message='Минимальное время приготовления в минутах: 1'), django.core.validators.MaxValueValidator(360, message='Максимальное время приготовления в минутах: 360')], verbose_name='Время в мин.')),
